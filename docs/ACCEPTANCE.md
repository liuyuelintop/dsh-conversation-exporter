...
| F | Interrupted turn (aborted, no response) + open turn at EOF (incomplete) | `test/fixtures/f-interrupted.jsonl` | Human messages render; missing responses render the documented markers; equals `test/golden/f-interrupted.md` |
